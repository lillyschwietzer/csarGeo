...
![](images/clipboard-1829017735.png){width="1060"}
...
For its SAR analysis countryside_sar uses the sars package
...
21 22 distanve metrics, bray-curtis?, linkage methods

limitations

feasible to change sar settings?
