...
Optionally, the user can import a custom polygon hull using 'custom_hull' for the analysis area of method 'circles', which will be auto-generated otherwise. It should share the same coordinate reference system (CRS) as the raster file, the latter of which should have appropriately projected coordinate data, especially for edge cases like polar or equatorial regions (Kumar et al., 2023).
